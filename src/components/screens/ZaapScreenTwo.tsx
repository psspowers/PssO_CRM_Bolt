...
interface ZaapScreenTwoProps {
  forcedOpenId?: string | null;
}

export const ZaapScreenTwo: React.FC<ZaapScreenTwoProps> = ({ forcedOpenId }) => {
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between gap-2 mb-1">
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <h1 className="text-2xl font-bold text-slate-900">Zaap (Staging)</h1>
            </div>
