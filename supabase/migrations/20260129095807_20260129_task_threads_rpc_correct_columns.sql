/*
  # Fix Task Master RPC Function - Correct Column Names

  1. Changes
    - Use correct column names: `name` instead of `full_name`
    - Use correct column names: `avatar` instead of `avatar_url`
*/
