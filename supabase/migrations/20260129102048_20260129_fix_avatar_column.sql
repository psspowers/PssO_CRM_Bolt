/*
  # Fix Task Threads RPC - Avatar Column Correction

  1. Changes
    - Fix avatar column reference in get_task_threads function
    - Change from 'u.avatar_url' to 'u.avatar' (correct column name in crm_users)
  
  2. Notes
    - This prevents RPC crashes when fetching task assignee avatars
    - The crm_users table uses 'avatar' not 'avatar_url'
*/

-- Drop and recreate function with correct avatar column reference
